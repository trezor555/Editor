...
void TranslationTool::SetPosition(glm::vec3 pos)
{
	m_position = pos;

}

glm::vec3 TranslationTool::GetPosition()
{
	return m_position;
}

void TranslationTool::Update(glm::vec3& cameraPos)
{
	if (!m_bVisible)
		return;
...
glm::vec3 TranslationTool::GetScale()
{
	return m_scale;
}

double TranslationTool::rayToLineSegment(glm::dvec3& rayOrigin, glm::dvec3& rayVec, const glm::dvec3& lineStart, glm::dvec3& lineEnd)
{
...
void TranslationTool::SetRay(Ray& ray)
{
	m_ray = ray;
}

void TranslationTool::MousePressDown()
{
	
}

void TranslationTool::MouseMove(glm::dmat4 view, glm::dmat4 projection, int mouseXPos, int mouseYPos, int screenwidth, int screenheight)
{
	if (!m_bVisible)
		return;
...
void TranslationTool::ReColorAxis(int id_1, int id_2, float color_1, float color_2, float color_3)
{
...
bool TranslationTool::RayToLineIsInBounds(glm::dmat4 view, glm::dmat4 projection, int mouseXPos, int mouseYPos, int screenwidth, int screenheight)
{
	glm::tvec4<double> viewport = glm::vec4(0, 0, screenwidth, screenheight);
	double winX = (double)mouseXPos;
	double winY = viewport[3] - mouseYPos;
...
void TranslationTool::LeftMouseButtonReleased()
{
	m_currentAxis = AXIS_NONE;
	glBindBuffer(GL_ARRAY_BUFFER, VBO);
	ReColorAxis(0, 1, 1, 0, 0);
...
void TranslationTool::SetVisible(bool visible)
{
	m_bVisible = visible;
}

bool TranslationTool::GetVisible()
{
	return m_bVisible;
}

void TranslationTool::SetPositionX(float val)
{
	m_position.x = val;
}

void TranslationTool::SetPositionY(float val)
{
	m_position.y = val;
}

void TranslationTool::SetPositionZ(float val)
{
	m_position.z = val;
}

void TranslationTool::SetGridSnapWidth(unsigned int val)
{
	m_iGridCubeWidth = val;
}

void TranslationTool::SetGridSnapHeight(unsigned int val)
{
	m_iGridCubeHeight = val;
}

void TranslationTool::SetGridSnapDepth(unsigned int val)
{
	m_iGridCubeDepth = val;
}

unsigned int TranslationTool::GetGridSnapWidth() const
{
	return m_iGridCubeWidth;
}

unsigned int TranslationTool::GetGridSnapHeight() const
{
	return m_iGridCubeHeight;
}

unsigned int TranslationTool::GetGridSnapDepth() const
{
	return m_iGridCubeDepth;
}
